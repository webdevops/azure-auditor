...
// 	logAnalyticsClient := operationalinsightsQuery.NewQueryClientWithBaseURI(auditor.azure.client.GetEnvironment().ResourceIdentifiers.OperationalInsights + OperationInsightsWorkspaceUrlSuffix)
// 	auditor.decorateAzureClient(&logAnalyticsClient.Client, auditor.azure.client.GetAuthorizerWithResource(auditor.azure.client.GetEnvironment().ResourceIdentifiers.OperationalInsights))
//
...
// 	}
//
// 	client := operationalinsightsResource.NewWorkspacesClientWithBaseURI(auditor.azure.client.GetEnvironment().ResourceManagerEndpoint, resourceInfo.Subscription)
