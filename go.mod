...
require (
	...
	github.com/webdevops/go-common v0.0.0-20230813195800-e31f7fab92d7
	go.uber.org/zap v1.25.0
	gopkg.in/yaml.v3 v3.0.1
)

require (
	github.com/Azure/azure-sdk-for-go/sdk/azcore v1.8.0-beta.2 // indirect
	...
	github.com/microsoftgraph/msgraph-sdk-go v1.14.0 // indirect
